...
@Component({
  ...
  templateUrl: './edit-favorites.component.html',
  styleUrls: ['./edit-favorites.component.css']
})
export class EditFavoritesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.subs.add(this.route.params.subscribe(params => {
      ...
      this.oldPizza = this.globalService.currentPerson.favorites[this.oldPizzaIndex];
  ...
  updatePizza(pizzaSizeIndex: number) {
    ...
    this.subs.add(this.personService.updatePerson(this.globalService.currentPerson).subscribe(
      (response) => {
        console.log(response);
        this.router.navigate([`favorites/listpizzas`]).then((e) => {
          if (e) {
